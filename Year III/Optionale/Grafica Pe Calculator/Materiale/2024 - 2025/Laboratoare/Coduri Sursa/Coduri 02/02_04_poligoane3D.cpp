...
//	Parametri pentru glm::ortho() - proiectie;
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("Fata si spatele poligoanelor in context 3D");			  //	Creeaza fereastra de vizualizare, indicand numele acesteia;
